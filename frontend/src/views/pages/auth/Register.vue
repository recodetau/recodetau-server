...
<template>
    <div class="text-center mb-5">
        <div class="text-900 text-3xl font-medium mb-3">Регистрации</div>
        <span class="text-600 font-medium">Нужно заполнить все поля чтобы зайти!</span>
    </div>
    ...
    <form @submit="onSubmit">
        ...
        <Button label="Отправить" type="submit" class="w-full p-3 text-xl"></Button>
    </form>
</template>
